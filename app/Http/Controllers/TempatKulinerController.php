...
class TempatKulinerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'rating_gofood' => 'nullable|numeric|min:0|max:5',
            'rating_shopeefood' => 'nullable|numeric|min:0|max:5',
            'rating_grabfood' => 'nullable|numeric|min:0|max:5',
        ...
        try {
            ...
            PreferensiTempatKuliner::create([
                ...
                'rating_gofood' => $request->rating_gofood,
                'rating_shopeefood' => $request->rating_shopeefood,
                'rating_grabfood' => $request->rating_grabfood,
